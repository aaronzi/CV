...
\begin{document}
    ...
    \tagline{Elektrotechniker | Softwareingenieur}
    %% You can add multiple photos on the left or right
    \photoL{4cm}{Profil}

    \personalinfo{
        \email{aaron@zielstorff.com}\smallskip
        \phone{+49-30-62963482}
        \mobile{+49-177-2847470}\\
        \address{Ahornallee 16, 12555 Berlin, Deutschland}\smallskip
        \birthday{09. August 1998}\\
    ...
    \begin{paracol}{2}
        ...
        \cvsection{TECH STACK}
            ...
            \begin{sloppypar*}
                \cvtags{JavaScript, C\#, Java, Python, PHP, C/C++, MATLAB, HTML, CSS}
                \medskip

                \cvtags{Vue.js, .NET Framework, Maven, BaSyx, Milo, NumPy, PyTorch}
                \medskip

                \cvtags{Git, Docker, NGINX, OpenAPI, Linux, Windows, macOS}
                \medskip

                \cvtags{MySQL, MongoDB, Firebase, PHPMyAdmin}
                \medskip

                \cvtags{Visual Studio, Shell, Visual Studio Code, IntelliJ IDEA, Eclipse IDE}
                \medskip
        ...
        \cvsection{Weiteres}
            \begin{sloppypar}
                ...
                \cvtags{Enterprise Architect, CoDeSys, TIA-Portal, AI-Driven Development, Adobe Illustrator, \LaTeX, Asset Administration Shell, Blender, Adobe XD}
            \end{sloppypar}
        % ----- LEARNING -----
        ...
        \cvsection{Referenzen}
            ...
            \cvref{Dipl.-Ing.\ Dirk Schöttke}{htwberlin}{Dirk.Schoettke@htw-berlin.de}{Dirk.Schoettke@\\\:\:\:\:htw-berlin.de}
            \divider
        ...
        \cvsection{Berufserfahrung}
            \cvevent{Wissenschaftlicher Mitarbeiter}{HTW Berlin}{10 2023 -- Heute}{Berlin, Deutschland}
            \begin{itemize}
            ...
            \cvevent{Studentischer Mitarbeiter}{HTW Berlin}{03 2021 -- 09 2023}{Berlin, Deutschland}
            \begin{itemize}
        ...
        \cvsection{Ausbildung}
            \cvevent{M.\ Eng. Elektrotechnik}{HTW Berlin}{10 2021 -- 09 2023}{Berlin, Deutschland}
            \begin{itemize}
        ...
        \cvsection{Publikationen}
            \cvevent{Overcoming Challenges in Integrating Legacy Devices with\\ Asset Administration Shells - An OPC UA Case Study}{\cvreference{\faBook}{https://ieeexplore.ieee.org/document/10275536}}{09 2023}{}
            \begin{itemize}
                \item ETFA 2023 - 28th IEEE International Conference on Emerging Technologies and Factory Automation
                \item DOI: 10.1109/ETFA54631.2023.10275536
            \end{itemize}
            \divider

            \cvevent{Component Test - Test Strategies with Asset Administration Shells}{\cvreference{\faBook}{https://ieeexplore.ieee.org/document/10228026}}{06 2023}{}
            \begin{itemize}
                \item ISIE 2023 - 32nd IEEE International Symposium on Industrial Electronics
                \item DOI: 10.1109/ISIE51358.2023.10228026
            \end{itemize}
            \divider
            
            \cvevent{Integration of PLC for synchronization of plant segments with\\ Asset Administration Shells}{\cvreference{\faBook}{https://ieeexplore.ieee.org/document/9968774}}{10 2022}{}
            \begin{itemize}
                \item IECON 2022 - 48th Annual Conference of the IEEE Industrial Electronics Society
                \item DOI: 10.1109/IECON49645.2022.9968774
            \end{itemize}
        % ----- PUBLICATIONS -----
    \end{paracol}
\end{document}