...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Publikationen}
            \cvevent{Industrial Controls and Asset Administration Shells:\\ An Approach to the Synchronization of Plant Segments}{\cvreference{\faBook}{https://www.scitepress.org/Link.aspx?doi=10.5220/0011527200003329}}{10 2022}{}
            \begin{itemize}
                \item IN4PL 2022 - 3rd International Conference on Innovative Intelligent Industrial Production and Logistics
                \item DOI: 10.5220/0011527200003329
            \end{itemize}
            \divider
            ...
            \cvevent{Migration and synchronization of plant segments with\\ Asset Administration Shells}{\cvreference{\faBook}{https://ieeexplore.ieee.org/document/9921595}}{09 2022}{}
            \begin{itemize}
                \item ETFA 2022 - 27th IEEE International Conference on Emerging Technologies and Factory Automation
                \item DOI: 10.1109/ETFA52439.2022.9921595
            \end{itemize}
        % ----- PUBLICATIONS -----
    \end{paracol}
\end{document}